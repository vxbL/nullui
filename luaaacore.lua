...
local function switchTab(name)
    ...
    if prevFrame then
        tw(prevFrame, EASE, { Position = UDim2.new(isMobile and -0.06 or -0.04, 0, 0, 0) })
        task.delay(0.18, function()
    ...
    nextFrame.Position = UDim2.new(isMobile and 0.06 or 0.04, 0, 0, 0)
    nextFrame.Visible  = true
    task.delay(0.04, function()
        tw(nextFrame, MED, { Position = UDim2.new(0, 0, 0, 0) })
